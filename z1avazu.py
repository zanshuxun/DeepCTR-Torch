...
if __name__ == "__main__":
    ...
    print("pred_ans torch float32 memory usage: %.3f MB" % (sys.getsizeof(pred_ans)/1024/1024))
    print("pred_ans torch float64 memory usage: %.3f MB" % (sys.getsizeof(pred_ans.astype(np.float64))/1024/1024))
